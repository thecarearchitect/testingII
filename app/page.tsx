    ...
    return (
      <div className="flex flex-col h-screen overflow-hidden relative"
        ...
        <header className="glass-dark flex-shrink-0 relative z-10">
          <div className="max-w-3xl mx-auto px-4 h-14 flex items-center justify-between">
            <button onClick={goHome} className="flex items-center gap-2.5 hover:opacity-75 transition-opacity group">
              ...
              <span className="font-fraunces text-sm group-hover:opacity-75 transition-opacity" style={{ color: 'var(--text)' }}>
              ...
              <div className="hidden sm:flex gap-1 mr-2">
                {MODES.map(m => (
                  <button key={m.id}
                    ...
                    style={m.id !== activeMode ? { color: 'var(--text-sub)' } : undefined}
                  ><ModeIcon modeId={m.id} size={13} color={m.id === activeMode ? '#fbbf24' : 'var(--text-sub)'} /></button>
                ))}
              </div>
              <ThemeToggle />
              <button onClick={() => setShowSettings(true)}
                className={`w-8 h-8 flex items-center justify-center rounded-lg transition-colors ${
                  hasSettings ? 'text-amber-400 hover:bg-amber-500/10' : 'hover:bg-white/5'
                }`}
                style={!hasSettings ? { color: 'var(--text-sub)' } : undefined}>
                <Settings size={14} />
              </button>
        ...
        <div className="relative z-10 max-w-3xl mx-auto w-full px-4 pt-3 flex-shrink-0 flex items-center gap-2">
          <ModeIcon modeId={activeMode} size={14} color="var(--accent)" />
          <span className="text-xs font-medium" style={{ color: 'var(--text-sub)' }}>{mode.title}</span>
    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
      ...
      <nav style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span className="font-fraunces" style={{ color: 'var(--text)', fontSize: 15, fontWeight: 600 }}>
              PflegeAssistent <SparkleIcon />
            </span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <button
              ...
              style={{ color: 'var(--text-sub)', fontSize: 13, background: 'none', border: 'none', cursor: 'pointer' }}
            >
              Einstellungen
            </button>
            <button
      ...
      <section style={{ position: 'relative', overflow: 'hidden', background: 'var(--bg)' }}>
        ...
        <div style={{
          ...
          <h1 className="font-fraunces fade-up fade-up-1" style={{
            ...
            Pflege verstehen.<br />
            <span style={{ color: 'var(--accent)' }}>Ansprüche durchsetzen.</span>
          </h1>

          <p className="fade-up fade-up-2" style={{
            fontSize: 'clamp(16px, 2vw, 19px)',
            color: 'var(--text-sub)', lineHeight: 1.75,
      ...
      <section style={{ background: 'var(--bg)', padding: '0 24px 80px' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          <h2 style={{ fontSize: 22, fontWeight: 400, color: 'var(--text)', marginBottom: 20, letterSpacing: '-0.01em' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 28, flexWrap: 'wrap' }}>
            {['Kostenlos', 'Kein Konto nötig', 'Sofortige Antwort'].map(txt => (
              <span key={txt} style={{ fontSize: 12, color: 'var(--text-dimmer)' }}>{txt}</span>
            ))}
          </div>
        </div>
      </section>
      ...
      {/* ── FÜR WEN ── */}
      <section style={{ background: 'var(--bg-card2)', padding: 'clamp(80px, 10vw, 120px) 24px 60px' }}>
        <div className="reveal-scroll" style={{ maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
          <p style={{ fontSize: 18, color: 'var(--text)', lineHeight: 1.9, marginBottom: 28 }}>
          ...
          <p style={{ fontSize: 16, color: 'var(--text-sub)', lineHeight: 1.9 }}>
      ...
      {/* ── PROBLEM ── */}
      <section style={{ background: 'var(--bg)', padding: 'clamp(100px, 13vw, 150px) 24px 120px' }}>
        <div style={{ maxWidth: 700, margin: '0 auto' }}>
          <p className="reveal-scroll" style={{
            fontSize: 11, fontWeight: 700, textTransform: 'uppercase',
            letterSpacing: '3.5px', color: 'var(--text-sub)',
            ...
            {[
              ...
              <div key={i} className="reveal-scroll" style={{ transitionDelay: `${i * 0.15}s` }}>
                <p style={{
                  ...
                  {line1}<br />
                  <span style={{ color: 'var(--text-sub)' }}>{line2}</span>
                </p>
              </div>
            ))}
          </div>
      ...
      {/* ── WARUM NICHT CHATGPT ── */}
      <section style={{ background: 'var(--bg-card2)', padding: '120px 24px clamp(100px, 13vw, 150px)' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <h2 className="font-fraunces reveal-scroll" style={{
            ...
            bessere Antwort.<br />
            <span style={{ color: 'var(--text-sub)' }}>Sie brauchen die richtige Frage.</span>
          </h2>
          ...
          <div className="reveal-scroll" style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                letterSpacing: '2px', color: 'var(--text-sub)', marginBottom: 24,
              }}>
                Allgemeine KI
              </p>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                {[
                  ...
                  <li key={item} style={{
                    ...
                    <span style={{ color: 'var(--border)', marginTop: 3, flexShrink: 0 }}>–</span>
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <div style={{
              ...
              <p style={{
                fontSize: 13, fontWeight: 700, textTransform: 'uppercase',
                letterSpacing: '2px', color: 'var(--accent)', marginBottom: 24,
              }}>
                PflegeAssistent
              </p>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
          ...
          <div className="reveal-scroll" style={{
            ...
            <p style={{
              fontSize: 15, fontStyle: 'italic',
              color: 'var(--text)', lineHeight: 1.8, marginBottom: 20,
            }}>
              „Meine Tochter hat das Down-Syndrom. Pflegegrad 3. Die Krankenkasse lehnt den Integrationshelfer für die Schule ab."
            </p>
            <p style={{ fontSize: 14, color: 'var(--text-sub)', lineHeight: 1.7, marginBottom: 6 }}>
              Eine allgemeine KI liefert Informationen.
            </p>
            <p style={{ fontSize: 14, color: 'var(--text-sub)', lineHeight: 1.7, marginBottom: 16 }}>
          ...
          <div className="reveal-scroll" style={{ textAlign: 'center' }}>
            <p style={{ fontSize: 15, color: 'var(--text-sub)', lineHeight: 1.85, marginBottom: 24 }}>
      ...
      {/* ── FRISTEN-ASSISTENT ── */}
      <section style={{ background: 'var(--bg-card2)', padding: 'clamp(100px, 13vw, 150px) 24px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <p className="reveal-scroll" style={{
            fontSize: 18, color: 'var(--text-sub)', lineHeight: 1.75,
          ...
          <div style={{
            ...
            <div className="reveal-scroll" style={{
              ...
              <p style={{ fontSize: 22, fontWeight: 700, color: 'var(--accent)', marginBottom: 16, fontFamily: 'Fraunces, Georgia, serif' }}>01</p>
              <h3 style={{ fontSize: 16, fontWeight: 600, color: 'var(--text)', marginBottom: 20 }}>Dokument hochladen</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                {['Pflegegradbescheid', 'Hilfsmittelablehnung', 'Behindertenparkausweis', 'Schwerbehindertenausweis', 'Verordnung'].map(item => (
                  <li key={item} style={{ fontSize: 14, color: 'var(--text-sub)', lineHeight: 1.7, paddingBottom: 6 }}>{item}</li>
                ))}
              </ul>
            </div>
            ...
            <div className="reveal-scroll" style={{
              ...
              <p style={{ fontSize: 22, fontWeight: 700, color: 'var(--accent)', marginBottom: 16, fontFamily: 'Fraunces, Georgia, serif' }}>02</p>
              <h3 style={{ fontSize: 16, fontWeight: 600, color: 'var(--text)', marginBottom: 16 }}>Frist erkennen</h3>
              <p style={{ fontSize: 13, color: 'var(--text-dim)', lineHeight: 1.7, marginBottom: 14 }}>PflegeAssistent erkennt automatisch:</p>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                {['Widerspruchsfristen', 'Ablaufdaten', 'Verlängerungen', 'Wiedervorlagen'].map(item => (
                  <li key={item} style={{ fontSize: 14, color: 'var(--text-sub)', lineHeight: 1.7, paddingBottom: 6, display: 'flex', gap: 8 }}>
            ...
            <div className="reveal-scroll" style={{
              ...
              <p style={{ fontSize: 22, fontWeight: 700, color: 'var(--accent)', marginBottom: 16, fontFamily: 'Fraunces, Georgia, serif' }}>03</p>
              <h3 style={{ fontSize: 16, fontWeight: 600, color: 'var(--text)', marginBottom: 20 }}>Erinnert werden</h3>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                {[
                  ...
                  <p key={msg} style={{
                    fontSize: 13, fontStyle: 'italic', color: 'var(--text)', lineHeight: 1.65,
                    padding: '12px 14px',
      ...
      {/* ── PREMIUM ── */}
      <section style={{ background: 'var(--bg)', padding: 'clamp(100px, 13vw, 150px) 24px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>

          <p className="reveal-scroll" style={{
            fontSize: 11, fontWeight: 700, textTransform: 'uppercase',
            letterSpacing: '3.5px', color: 'var(--accent)',
            textAlign: 'center', marginBottom: 24,
          }}>
            Premium
          </p>
          ...
          <p className="reveal-scroll" style={{
            fontSize: 17, color: 'var(--text-sub)', lineHeight: 1.8,
          ...
          <div className="reveal-scroll" style={{
            ...
            {[
              ...
              <div key={f} style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
                ...
                <span style={{ fontSize: 14, color: 'var(--text-sub)', lineHeight: 1.65 }}>{f}</span>
              </div>
            ))}
          </div>
          ...
          <div className="reveal-scroll" style={{ textAlign: 'center', marginTop: 8 }}>
            <a
              href="/pricing"
              style={{ fontSize: 14, color: 'var(--text-sub)', textDecoration: 'none', transition: 'color .15s' }}
      ...
      <section style={{ background: 'var(--bg-card2)', padding: 'clamp(100px, 13vw, 150px) 24px' }}>
        <div style={{ maxWidth: 780, margin: '0 auto' }}>
          ...
          <div className="reveal-scroll" style={{
            ...
            <p style={{ marginTop: 36, fontSize: 13, color: 'var(--text-dim)', fontStyle: 'normal' }}>
              — Der Gründer
            </p>
          </div>
        </div>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={stat} className="reveal-scroll">
                ...
                <p style={{ fontSize: 14, color: 'var(--text-sub)', lineHeight: 1.6 }}>{label}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ background: 'var(--bg-card2)', padding: 'clamp(100px, 13vw, 150px) 24px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{
            ...
            {[
              { id: 'widerspruch' as ModeId, title: 'Widerspruch schreiben', text: 'Bescheid erhalten? Wir formulieren.', cta: 'Widerspruch vorbereiten →' },
              { id: 'allgemein' as ModeId, title: 'Pflegegrad & Leistungen', text: 'Was steht dir zu? Wir prüfen es.', cta: 'Pflegegrad prüfen →' },
              { id: 'formular' as ModeId, title: 'Formulare verstehen', text: 'Kein Juradeutsch mehr.', cta: 'Formular hochladen →' },
              { id: 'rechtlich' as ModeId, title: 'Rechtliche Fragen', text: 'Deine Rechte, klar erklärt.', cta: 'Frage stellen →' },
              { id: 'pflegealltag' as ModeId, title: 'Pflegealltag', text: 'Praktische Hilfe für jeden Tag.', cta: 'Jetzt fragen →' },
              ...
              <div key={id} className="reveal-scroll" style={{
                ...
                <p style={{ fontSize: 14, color: 'var(--text-sub)', lineHeight: 1.7, flexGrow: 1 }}>
                  {text}
                </p>
                <button
                  onClick={() => openChat(id)}
      ...
      <section style={{ background: 'var(--bg)', padding: 'clamp(100px, 13vw, 150px) 24px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{
            ...
            {[
              { quote: 'Ich wusste nicht, dass ich Widerspruch einlegen kann. Jetzt haben wir Pflegegrad 3 bekommen.', role: 'Pflegende Mutter eines Kindes mit Behinderung' },
              { quote: 'Endlich versteht jemand, was in diesen Formularen steht.', role: 'Pflegender Ehemann, Demenzerkrankung der Partnerin' },
              { quote: 'Der MDK-Termin war das erste Mal, dass ich vorbereitet war.', role: 'Angehörige einer Pflegebedürftigen, Pflegegrad 2' },
            ].map(({ quote, role }, i) => (
              <div key={role} className="reveal-scroll" style={{
                ...
                <p style={{ fontSize: 13, color: 'var(--text-sub)', fontWeight: 400 }}>
                  — {role}
                </p>
              </div>
            ))}
      ...
      {/* ── AMBER CTA ── */}
      <section style={{ background: 'var(--accent)', padding: 'clamp(100px, 13vw, 150px) 24px' }}>
        <div style={{ maxWidth: 680, margin: '0 auto', textAlign: 'center' }}>
          <h2 className="font-fraunces reveal-scroll" style={{
            fontSize: 'clamp(32px, 5.5vw, 56px)',
            fontWeight: 300, color: '#18182a',
          ...
          <button
            ...
            onClick={() => openChat('allgemein')}
            style={{
              background: '#18182a', color: '#f0ede8',
              border: 'none', borderRadius: 9999,
      ...
      <footer style={{ background: 'var(--bg)', borderTop: '1px solid var(--border)', padding: '48px 24px' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          <p style={{ fontSize: 12, color: 'var(--text-sub)', lineHeight: 1.9 }}>
          ...
          <p style={{ marginTop: 16, fontSize: 12, color: 'var(--text-dim)' }}>
            <a href="/impressum" style={{ color: 'var(--text-dim)', fontSize: 12, textDecoration: 'none' }}
              onMouseEnter={e => (e.currentTarget.style.color = 'var(--text-sub)')}
              onMouseLeave={e => (e.currentTarget.style.color = 'var(--text-dim)')}>
              Impressum
            </a>
            <span style={{ margin: '0 10px', color: 'var(--border)' }}>·</span>
            <a href="/datenschutz" style={{ color: 'var(--text-dim)', fontSize: 12, textDecoration: 'none' }}
              onMouseEnter={e => (e.currentTarget.style.color = 'var(--text-sub)')}
              onMouseLeave={e => (e.currentTarget.style.color = 'var(--text-dim)')}>
              Datenschutz
            </a>
